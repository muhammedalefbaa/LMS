        ...
        {courseData ? (
          <>
            ...
            <div className="max-w-xl z-10 text-gray-500">
              ...
              <p>
                Course by{" "}
                <span className="text-blue-600 underline">hello world</span>
              </p>
            ...
            {/* right column */}
            <div className="max-w-[434px] z-10 shadow-[0px_4px_15px_2px] shadow-black/2 rounded-t md:rounded-non overflow-hidden bg-white min-w-[300px] sm:min-w[420px]">
              {playerData ? (
                <YouTube
